...
export function Cards({removeCard, listColor ,key, colorSelect}) {       
...
<div  className="list_template list_new" >
    ...
    <div action="" method="post" className="list_form">
        <input maxLength="15" required type="text" name="title_box_1" placeholder="Give a Title" className="list_title_1" style={{ backgroundColor: listColor }} onChange={ (e) =>setTitle(e.target.value)} value={title}/>
        <select name="color_list" className="color_list" defaultValue="status_blue">
            <option value="status_blue" className="status_blue" onClick={colorSelect}></option>
